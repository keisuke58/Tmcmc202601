...
\midrule
gLV (L-BFGS-B, 5 starts)            & 10 & 10 & 0.050 & 0.059$^{\ddagger}$ & none\\
...
\end{tabular}
\smallskip\\
\footnotesize $^\ddagger$gLV LOO computed on 8 complete patients using gLV+struct LOO as proxy (PerLive scaling provides no LOO gain; see text).
\end{table}
