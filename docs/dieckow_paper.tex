...
At the community level, a 10-guild generalised Lotka-Volterra (gLV) model fit to all 53 genera achieves RMSE\,$=\,$0.050 ($r=0.963$); leave-one-out cross-validation on the 8 patients with complete three-week data gives RMSE\,$=\,$0.059.
...
\item \textbf{Guild-level gLV.} A 10-guild generalised Lotka-Volterra replicator model fit on all 10 patients achieves $r=0.963$ (RMSE\,$=0.050$); the 11-guild/8-patient consistent fit gives RMSE\,$=0.060$ ($r=0.927$).
Actinobacteria$\to$Bacilli is the dominant positive driver in both fits.
