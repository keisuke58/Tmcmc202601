...
Hamilton ODE without structural data uses 10 guilds (two guilds absent from the JAX solver initialisation).}
\label{tab:rmse_guild}
\begin{tabular}{@{}llcl@{}}
\toprule
\textbf{Model} & \textbf{Guilds} & \textbf{RMSE} & \textbf{Structural data used}\\
\midrule
gLV (L-BFGS-B, 5 starts)            & 11 & 0.050 & none\\
gLV + struct (PerLive-scaled $b$)    & 11 & 0.060 & $q_{p,w}$ only\\
