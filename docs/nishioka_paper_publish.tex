...
\midrule
CS & \textbf{.273} & .135 & .111 & .244 \\
CH & .229 & \textbf{.168} & .127 & .233 \\
DS & .273 & .130 & \textbf{.062} & .252 \\
DH & .301 & .129 & .044 & \textbf{.262} \\
\bottomrule
\end{tabular}
\caption{Cross-condition prediction RMSE. Diagonal (bold): self-prediction. DH$\to$DS (0.044) outperforms DS self (0.062), confirming a shared dysbiotic backbone.}
