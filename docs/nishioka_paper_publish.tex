...
||||||| parent of a440e223 (fix: final paper QC — remove stale UMAP refs, dup sentence, wrong bold)
CS & \textit{0.273} & $\mathbf{0.135}$ & $\mathbf{0.111}$ & 0.244 \\
CH & 0.229 & \textit{0.168} & $\mathbf{0.127}$ & 0.233 \\
...
DS & 0.273 & 0.130 & \textit{0.062} & 0.252 \\
DH & 0.301 & 0.129 & $\mathbf{0.044}$ & \textit{0.262} \\
>>>>>>> a440e223 (fix: final paper QC — remove stale UMAP refs, dup sentence, wrong bold)
\bottomrule
\end{tabular}
