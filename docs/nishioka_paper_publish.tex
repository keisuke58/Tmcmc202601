...
\bottomrule
\end{tabular}
\captionof{table}{Experimentally confirmed species interactions~\cite{Heine2025PeriImplant}. All 20 parameters are estimated without a priori locking; the posterior concentrates near zero for biologically inactive pairs.}
\label{tab:active}
\end{minipage}
