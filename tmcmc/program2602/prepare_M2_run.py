...
def main():
    ...
    parser.add_argument(
        "--run-id", type=str, default="manual_M2_high_precision", help="Run ID for output directory"
    )
    ...
    theta_true = [
        ...
        1.0,
        0.1,
        0.2,  # M1: a11, a12, a22, b1, b2
        1.5,
        1.0,
        2.0,
        0.3,
        0.4,  # M2: a33, a34, a44, b3, b4
        2.0,
        1.0,
        2.0,
        1.0,  # M3: a13, a14, a23, a24
        1.2,
        0.25,  # M4: a55, b5
        1.0,
        1.0,
        1.0,
        1.0,  # M5: a15, a25, a35, a45
    ]
