...
class BiofilmTSM5S:
    ...
    def __init__(self, solver: BiofilmNewtonSolver5S, active_theta_indices=None,
                 cov_rel: float = 0.005, theta_linearization=None):
        self.solver = solver
    ...
    def solve_tsm(self, theta):
        ...
        if (self._deterministic_solution_cached is None or 
            self._last_center_solved is None or 
            not np.allclose(theta_center, self._last_center_solved)):
