...
def verify_against_complex_step(
    ...
    for k in range(n_active):
        ...
        A_plus[0, 1] = theta_plus[1]
        A_plus[1, 0] = theta_plus[1]
        ...
        A_plus[2, 3] = theta_plus[6]
        A_plus[3, 2] = theta_plus[6]
        A_plus[3, 3] = theta_plus[7]
        b_diag_plus[2] = theta_plus[8]
        b_diag_plus[3] = theta_plus[9]

        # M3 cross-interaction block
        A_plus[0, 2] = theta_plus[10]
        A_plus[2, 0] = theta_plus[10]
        A_plus[0, 3] = theta_plus[11]
        A_plus[3, 0] = theta_plus[11]
        A_plus[1, 2] = theta_plus[12]
        A_plus[2, 1] = theta_plus[12]
        A_plus[1, 3] = theta_plus[13]
        A_plus[3, 1] = theta_plus[13]
