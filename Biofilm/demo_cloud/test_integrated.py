...
class BayesianOptimizer:
    ...
    def objective_M1(self, params, data):
        ...
        log_L, _, _ = likelihood_with_uncertainty(
            params, data, self.solver.run_M1, n_mc_samples=3
        )
        loss = -log_L
    ...
    def objective_M2(self, params, data):
        """Objective for M2"""
        log_L, _, _ = likelihood_with_uncertainty(
            params, data, self.solver.run_M2, n_mc_samples=3
        )
        loss = -log_L
        self._record(loss, params)
        return loss
    ...
    def objective_M3(self, params, data, m1, m2):
        ...
        log_L, _, _ = likelihood_with_uncertainty(
            params, data, solver_func, n_mc_samples=3
        )
        loss = -log_L
        self._record(loss, params)
        return loss
