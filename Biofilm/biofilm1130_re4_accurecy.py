...
Enhancements:
2. Confidence Interval Visualization (95% CI)
3. Convergence Diagnostics (R-hat, ESS, Trace plots)
4. Model Validation Metrics (AIC, BIC, Posterior Predictive Check)
...
def main():
    ...
    fit_std_M1 = np.ones_like(fit_M1) * 0.01  # Simplified uncertainty
    ...
    print(f"\n  Results saved to: estimation_results.csv")
    ...
    if val is not None:
        visualizer.plot_validation_with_prediction(
            t, val, "fig_validation_antibiotic_shock.png"
        )
    
    # =========================================================================
    # SENSITIVITY ANALYSIS (Optional - simplified)
    # =========================================================================
    print("\n" + "="*75)
    print("Running Sensitivity Analysis (Sobol Indices Approximation)...")
    print("="*75)
    
    # Simplified sensitivity for M1
