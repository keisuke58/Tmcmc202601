...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{paper_comprehensive_figs/Commensal_HOBIC_Fig_A02_per_species_panel.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{paper_comprehensive_figs/Commensal_HOBIC_Fig_A01_interaction_matrix_heatmap.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{paper_comprehensive_figs/Commensal_HOBIC_Fig_A05_parameter_violins.png}
...
\textbf{Description}: Disease condition under flow (HOBIC). Characterized by the explosive growth ('Surge') of F. nucleatum and P. gingivalis.
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{paper_comprehensive_figs/Dysbiotic_HOBIC_Fig_A02_per_species_panel.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{paper_comprehensive_figs/Dysbiotic_HOBIC_Fig_A01_interaction_matrix_heatmap.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{paper_comprehensive_figs/Dysbiotic_HOBIC_Fig_A05_parameter_violins.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{paper_comprehensive_figs/Commensal_Static_Fig_A02_per_species_panel.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{paper_comprehensive_figs/Commensal_Static_Fig_A01_interaction_matrix_heatmap.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{paper_comprehensive_figs/Commensal_Static_Fig_A05_parameter_violins.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{paper_comprehensive_figs/Dysbiotic_Static_Fig_A02_per_species_panel.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{paper_comprehensive_figs/Dysbiotic_Static_Fig_A01_interaction_matrix_heatmap.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{paper_comprehensive_figs/Dysbiotic_Static_Fig_A05_parameter_violins.png}
