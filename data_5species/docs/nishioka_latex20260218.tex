...
\vspace{0.5cm}
\noindent\textbf{Keywords:} Bayesian Estimation, Biofilm Mechanics, TMCMC, DeepONet, Dysbiosis Index, Multi-species Interaction, Inverse Problem, Peri-implantitis, Uncertainty Quantification, Graph Neural Networks
\end{abstract}
