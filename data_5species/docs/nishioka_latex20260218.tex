...
\begin{figure}[htbp]
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{nishioka_algorithm_figs/froh-06-1649419-g001.jpg}
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{nishioka_algorithm_figs/froh-06-1649419-g002.jpg}
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{nishioka_algorithm_figs/froh-06-1649419-g003.jpg}
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{nishioka_algorithm_figs/froh-06-1649419-g004.jpg}
...
\begin{figure}[h]
\centering
\includegraphics[width=1.0\textwidth]{nishioka_algorithm_figs/TSM_simulation_Commensal_Static_MAP_Fit_with_data.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=1.0\textwidth]{nishioka_algorithm_figs/posterior_predictive_Commensal_Static_PosteriorBand.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=1.0\textwidth]{nishioka_algorithm_figs/residuals_Commensal_Static_Residuals.png}
...
% \begin{figure}[h]
% \centering
% \includegraphics[width=1.0\textwidth]{nishioka_algorithm_figs/pub_parameter_boxplots.png}
...
% \begin{figure}[h]
% \centering
% \includegraphics[width=0.8\textwidth]{nishioka_algorithm_figs/pub_interaction_heatmap.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{paper_comprehensive_figs/Fig_A02_per_species_panel.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{paper_comprehensive_figs/Fig_A01_interaction_matrix_heatmap.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{paper_comprehensive_figs/Fig_A05_parameter_violins.png}
