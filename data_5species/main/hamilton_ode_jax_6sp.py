...
def theta_to_matrices_6sp(theta):
    ...
    A = A.at[0, 2].set(theta[3])
    A = A.at[2, 0].set(theta[3])
    A = A.at[1, 2].set(theta[4])
    A = A.at[2, 1].set(theta[4])
    A = A.at[2, 2].set(theta[5])
    # Column 3 (Vp): A[0,3], A[1,3], A[2,3], A[3,3]
    A = A.at[0, 3].set(theta[6])
    A = A.at[3, 0].set(theta[6])
    A = A.at[1, 3].set(theta[7])
    A = A.at[3, 1].set(theta[7])
    A = A.at[2, 3].set(theta[8])
    A = A.at[3, 2].set(theta[8])
    A = A.at[3, 3].set(theta[9])
    # Column 4 (Fn): A[0,4], A[1,4], A[2,4], A[3,4], A[4,4]
    A = A.at[0, 4].set(theta[10])
    A = A.at[4, 0].set(theta[10])
    A = A.at[1, 4].set(theta[11])
    A = A.at[4, 1].set(theta[11])
    A = A.at[2, 4].set(theta[12])
    A = A.at[4, 2].set(theta[12])
    A = A.at[3, 4].set(theta[13])
    A = A.at[4, 3].set(theta[13])
    A = A.at[4, 4].set(theta[14])
    # Column 5 (Pg): A[0,5], A[1,5], A[2,5], A[3,5], A[4,5], A[5,5]
    A = A.at[0, 5].set(theta[15])
    A = A.at[5, 0].set(theta[15])
    A = A.at[1, 5].set(theta[16])
    A = A.at[5, 1].set(theta[16])
    A = A.at[2, 5].set(theta[17])
    A = A.at[5, 2].set(theta[17])
    A = A.at[3, 5].set(theta[18])
    A = A.at[5, 3].set(theta[18])
    A = A.at[4, 5].set(theta[19])
    A = A.at[5, 4].set(theta[19])
