...
def parse_args():
    ...
    parser.add_argument("--commensal", type=str, required=True, help="Path to Commensal run directory")
    parser.add_argument("--dysbiotic", type=str, required=True, help="Path to Dysbiotic run directory")
    parser.add_argument("--output-dir", type=str, default="comparison_plots", help="Output directory")
