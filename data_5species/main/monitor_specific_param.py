...
def main():
    ...
    parser.add_argument("--dir", type=str, required=True, help="Path to run directory containing tmcmc_checkpoint.pkl")
    parser.add_argument("--idx", type=int, default=18, help="Parameter index to monitor (default: 18 for V->Pg)")
    parser.add_argument("--name", type=str, default="Theta", help="Parameter name for plot")
    parser.add_argument("--output", type=str, default="param_monitor.png", help="Output plot filename")
