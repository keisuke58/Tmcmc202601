...
def parse_args():
    ...
    parser.add_argument("--run-id", type=str, required=True, help="Run ID of the completed M5 estimation")
    parser.add_argument("--output-root", type=str, default=None, help="Root directory for outputs (default: derived from config)")
...
def main():
    ...
    logger.info(f"Loaded M5 MAP estimate (20 params).")
