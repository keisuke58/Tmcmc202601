...
def main():
    ...
    for _, row in conditions.iterrows():
        ...
        for i, species_color in enumerate(species_order):
            ...
            for day_idx, day in enumerate(days):
                ...
                if row_data.empty:
                    ...
                    stats = {
                        'med': 0, 'q1': 0, 'q3': 0, 'whislo': 0, 'whishi': 0,
                    ...
                    if q1 < whislo: whislo = q1
                    if q3 > whishi: whishi = q3
            ...
            box_props = dict(facecolor=COLORS[species_color], alpha=0.7, linewidth=1.5, edgecolor='black')
            ...
            artists = ax.bxp(stats_list, positions=positions, widths=box_width, 
        ...
        # Legend
        legend_patches = [plt.Rectangle((0,0),1,1, facecolor=COLORS[s], edgecolor='black', alpha=0.7) for s in species_order]
        legend_labels = [SPECIES_LABELS[s] for s in species_order]
        ax.legend(legend_patches, legend_labels, loc='upper left', bbox_to_anchor=(1, 1), title="Species")
